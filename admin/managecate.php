                                                    ...
                                                    <?php 
                                                        if($result_data->num_rows>0){
                                                            ...
                                                            while($row = $result_data->fetch_array()){
                                                                ...
                                                                <td class='text-right'>
                                                                    <a href='editcate.php?edit={$row['cat_id']}' class='btn btn-link btn-warning btn-just-icon edit'>
                                                                    EDIT
                                                                    </a>
                                                                    <a href='managecate.php?delete={$row['cat_id']}' class='btn btn-link btn-danger btn-just-icon remove'>
                                                                    DELETE
                                                                    </a>
                                                                </td>
                                                            </tr>";
